...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 13.0, 447.0, 24.0 ],
					"text" : "buf: a demonstration of buffer~ resizing from a Max external"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.5, 87.0, 75.0, 19.0 ],
					"text" : "start here "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 90.0, 183.0, 63.0, 21.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.0, 139.0, 103.0, 21.0 ],
					"text" : "resize drum 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.5, 110.0, 103.0, 21.0 ],
					"text" : "resize drum 62219"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 134.0, 220.0, 106.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.5, 183.0, 28.0, 23.0 ],
					"text" : "buf"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 300.0, 254.5, 99.5, 254.5 ],
					"source" : [ "obj-9", 0 ]
				}
